...
Thus, resulting in comparison between the 2 user searched movies based on their stats such as awards, gross etc.

### Main technical accomplishments:
* Fully resuable autocomplete input suggestion box. (create from scratch)
* Use debounce approach on user input.
